...
export const Gauge = (props: GaugeProps) => (
  <div className={styles.wrapper + " " + styles.aliasingFix}>
    <div className={styles.container + " " + error.grayOut + " " + (props.isError ? error.grayOutTriggered : "")}>
    ...
    <div title={props.errorTooltip} className={error.error + " " + (props.isError ? error.errorTriggered : "")}/>
  </div>
);
