...
SDSHub::SDSHub(HardwareSerial &serial):
    ...
    pm25(Sensor<float>("PM 2.5", "SDS", "pm2.5", new WindowedValue<float, SAMPLE_BACKLOG>("μg/m³", 0, 1000))),
    pm10(Sensor<float>("PM 10", "SDS", "pm10", new WindowedValue<float, SAMPLE_BACKLOG>("μg/m³", 0, 1000)))
{}
